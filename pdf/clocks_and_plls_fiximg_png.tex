...
{
\centering
\aicfig{media/l10_clockic_tikz.png}
}
...
{
\centering
\aicfig{media/l10_freq_fb_tikz.png}
}
...
{
\centering
\aicfig{media/l08_pll_m_tikz.png}
}
...
{
\centering
\aicfig{media/l08_pll_sd_tikz.png}
}
...
{
\centering
\aicfig{media/l08_pll_mod_tikz.png}
}
...
{
\centering
\aicfig{media/sunpll_top_tikz.png}
}
...
{
\centering
\aicfig{media/l10_pll_sm_tikz.png}
}
...
{
\centering
\aicfig{media/sunpll_rosc_tikz.png}
}
...
{
\centering
\aicfig{media/SUN_PLL_ROSC_KVCO_tikz.png}
}
...
{
\centering
\aicfig{media/sunpll_pfd_tikz.png}
}
...
{
\centering
\aicfig{media/sunpll_cp_tikz.png}
}
...
{
\centering
\aicfig{media/sunpll_lpf_tikz.png}
}
...
{
\centering
\aicfig{media/sunpll_divn_tikz.png}
}
...
{
\centering
\aicfig{media/sun_pll_lay_typ_tikz.png}
}
...
PD/CP Noise is Not Multiplied by N2 {[}1{]}

All-digital PLL and transmitter for mobile phones {[}2{]}

A 2.9--4.0-GHz Fractional-N Digital PLL With Bang-Bang Phase Detector
and 560-fsrms Integrated Jitter at 4.5-mW Power {[}3{]}
