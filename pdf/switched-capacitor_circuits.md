...
<small><sub>_Figure 1: General purpose Active-RC biquad_</sub></small>
...
<!-- ../media/l4_gmcbi_tikz.pdf -->

![](media/l4_gmcbi_tikz.pdf)


<small><sub>_Figure 2: General purpose Gm-C biquad_</sub></small>
...
<!-- ../media/l05_fund1_tikz.pdf -->

![](media/l05_fund1_tikz.pdf)


<small><sub>_Figure 3: Switched capacitor with two transistor switches and the non-overlapping clock phases $\phi_1$ and $\phi_2$_</sub></small>
...
<!-- ../media/l05_fund2_tikz.pdf -->

![](media/l05_fund2_tikz.pdf)


<small><sub>_Figure 4: The same switched capacitor rotated, now between the input and an output voltage source_</sub></small>
...
<!-- ../media/l05_fund3_tikz.pdf -->

![](media/l05_fund3_tikz.pdf)


<small><sub>_Figure 5: Switched capacitor with series switches, charging $C_1$ to $V_I$ in $\phi_1$ and $V_O$ in $\phi_2$_</sub></small>
...
<!-- ../media/l5_dtfig_tikz.pdf -->

![](media/l5_dtfig_tikz.pdf)


<small><sub>_Figure 7: Time domain and spectrum of the emulated continuous time signal (left) and the sampled signal with its spectral copies (right)_</sub></small>
...
<!-- ../media/l5_sh_tikz.pdf -->

![](media/l5_sh_tikz.pdf)


<small><sub>_Figure 8: Spectrum before and after sampling: unwanted signals above $f_s/2$ fold into the wanted band_</sub></small>
...
<!-- ../media/l5_shaaf_tikz.pdf -->

![](media/l5_shaaf_tikz.pdf)


<small><sub>_Figure 9: An anti-alias low-pass filter attenuates the unwanted components before sampling_</sub></small>
...
<!-- ../media/l5_subsample_tikz.pdf -->

![](media/l5_subsample_tikz.pdf)


<small><sub>_Figure 10: Sub-sampling: a band-pass filtered signal above $f_s/2$ folds down to low frequency on sampling_</sub></small>
...
<!-- ../media/l5_sdomain_tikz.pdf -->

![](media/l5_sdomain_tikz.pdf)


<small><sub>_Figure 11: A complex conjugate pole pair in the s-plane_</sub></small>
...
<small><sub>_Warning: First-order approximation [https://en.wikipedia.org/wiki/Bilinear_transform](https://en.wikipedia.org/wiki/Bilinear_transform)_</sub></small>


<!-- ../media/l5_zdomain_tikz.pdf -->

![](media/l5_zdomain_tikz.pdf)


<small><sub>_Figure 12: The z-plane with the unit circle and a complex conjugate pole pair_</sub></small>
...
<small><sub>_ Head's up: Fig 13.12 in AIC is wrong _</sub></small>
...
<!-- ../media/l5_zunstable_tikz.pdf -->

![](media/l5_zunstable_tikz.pdf)


<small><sub>_Figure 13: Poles inside the unit circle are stable, poles outside are unstable_</sub></small>
...
<!-- ../media/l5_iir_tikz.pdf -->

![](media/l5_iir_tikz.pdf)


<small><sub>_Figure 14: Time domain and spectrum of the sampled signal (left) and the second order IIR filtered output (right)_</sub></small>
...
<!-- ../media/l5_fir_tikz.pdf -->

![](media/l5_fir_tikz.pdf)


<small><sub>_Figure 15: FIR filter summing the input and two delayed samples, each weighted by 1/3_</sub></small>
...
<!-- ../media/l5_scintro1_tikz.pdf -->

![](media/l5_scintro1_tikz.pdf)


<small><sub>_Figure 16: SC circuit during phase 1: $V_1$ is stored on $C_1$ while $C_2$ is shorted_</sub></small>
...
<!-- ../media/l5_scintro2_tikz.pdf -->

![](media/l5_scintro2_tikz.pdf)


<small><sub>_Figure 17: SC circuit during phase 2: the OTA transfers the charge from $C_1$ to $C_2$_</sub></small>
...
<!-- ../media/l5_scamp_tikz.pdf -->

![](media/l5_scamp_tikz.pdf)


<small><sub>_Figure 18: Switched capacitor gain circuit sampling $V_i$ on $C_1$ in phase 1 and transferring the charge to $C_2$ in phase 2_</sub></small>
...
<!-- ../media/l5_scfig_tikz.pdf -->

![](media/l5_scfig_tikz.pdf)


<small><sub>_Figure 19: Discrete time output of the gain circuit, only valid towards the end of phase 2_</sub></small>
...
<!-- ../media/l5_scint_tikz.pdf -->

![](media/l5_scint_tikz.pdf)


<small><sub>_Figure 20: Switched capacitor integrator: without the reset switch the charge accumulates on $C_2$_</sub></small>
...
<!-- ../media/l5_scifig_tikz.pdf -->

![](media/l5_scifig_tikz.pdf)


<small><sub>_Figure 21: Integrator output growing every clock cycle as the input charge is accumulated_</sub></small>
...
<!-- ../media/l5_diffota_cmfb_tikz.pdf -->

![](media/l5_diffota_cmfb_tikz.pdf)


<small><sub>_Figure 22: The common mode feedback amplifier. VON and VOP are sensed through 60k||20f networks and compared against a 100k/100k mid-supply reference. Each load PMOS is diode connected on its own - the gates are not tied together - so the gain is the modest, well defined $g_{mn}/g_{mp}$ that a common mode loop wants, and the correction leaves as $V_{CMFB}$_</sub></small>


<!-- ../media/l5_diffota_tikz.pdf -->

![](media/l5_diffota_tikz.pdf)


<small><sub>_Figure 23: The OTA itself, one side drawn, sized in multiples of the minimum gate length F: a cascoded PMOS tail into the input pair, a cascoded mirror making the first stage output, and a common source second stage with 500 fF of cascode compensation. $V_{CMFB}$ arrives from the amplifier in Figure 13_</sub></small>
...
<!-- ../media/l5_diffota_bias_tikz.pdf -->

![](media/l5_diffota_bias_tikz.pdf)


<small><sub>_Figure 24: The bias generator. The 10 uA reference is mirrored once in an ordinary current mirror - the line along the bottom - and everything above it is wide swing cascode: the narrow 8F12F devices set VCP and VCN, and in each master the mirror device's gate hangs on the far end of its own stack_</sub></small>
...
<!-- ../media/l5_sw1_tikz.pdf -->

![](media/l5_sw1_tikz.pdf)


<small><sub>_Figure 25: Switch implementations: NMOS, PMOS, transmission gate, and the transmission gate symbol_</sub></small>
...
<!-- ../media/l5_sw2_tikz.pdf -->

![](media/l5_sw2_tikz.pdf)


<small><sub>_Figure 26: Transmission gate with switched bulks (left) and a bootstrapped switch (right)_</sub></small>
...
<small><sub>_Figure 27: Layout and transient simulation of the 9-bit SAR ADC, with the bootstrapped sampling switch at the bottom_</sub></small>
...
<!-- ../media/l5_sw3_tikz.pdf -->

![](media/l5_sw3_tikz.pdf)


<small><sub>_Figure 28: Fully differential bootstrapped switch with cross coupled dummy transistors_</sub></small>
...
<!-- ../media/l5_novl_tikz.pdf -->

![](media/l5_novl_tikz.pdf)


<small><sub>_Figure 29: Non-overlapping clock generator and the resulting phases $\phi_1$ and $\phi_2$_</sub></small>
...
<!-- ../media/l5_scex_tikz.pdf -->

![](media/l5_scex_tikz.pdf)


<small><sub>_Figure 30: Switched capacitor amplifier scaling the bipolar generated voltage by $C_1/C_2 = 10$_</sub></small>
