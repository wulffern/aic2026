...
{
\centering
\aicfig{media/l4_achai_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_radio_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_first_order_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_biquad_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_gmc_diff_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_gmc_diff1_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_gmc1st_tikz.pdf}
}
...
With Duty-Cycled Gm-C Integrator {[}1{]}
...
{
\centering
\aicfig{media/l4_activerc_first_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_activerc_tikz.pdf}
}
...
See page 511 in {[}2{]} (chapter 5.8.1)
...
cross-coupling that makes the pair complex. Inspired by Breems et al.
{[}3{]}, which is fully differential, cascaded, and has a tuning
resistor on everything}
...
{
\centering
\aicfig{media/l04_complex_psd_tikz.pdf}
}
...
77 dB DR in a Near Zero-IF 20 MHz Band {[}3{]}

Complex signal processing is not - complex {[}4{]}
