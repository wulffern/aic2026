...
<small><sub>_Figure 1: A nanoscale NMOS in cross-section. Mechanical stress from the isolation trenches, the transverse and lateral fields in the channel, traps at the oxide interface, and hot carriers where the field peaks near the drain_</sub></small>
...
<small><sub>_Figure 2: ReRAM conductance distributions in the pristine, formed (LRS), and reset (HRS) states_</sub></small>
...
<!-- ../media/l9_sarc_tikz.pdf -->

![](media/l9_sarc_tikz.pdf)


<small><sub>_Figure 3: Example supply planning from VBUS and VBAT down to IO and core voltage, with a regulator between each domain_</sub></small>
...
<small><sub>_Figure 4: Regulators in the nRF5340, from the product specification. Source: Nordic Semiconductor, nRF5340 Product Specification_</sub></small>
...
<!-- ../media/l9_ldo_pmos_tikz.pdf -->

![](media/l9_ldo_pmos_tikz.pdf)


<small><sub>_Figure 5: Linear regulator with a PMOS pass-fet controlled by an OTA feedback loop_</sub></small>
...
<!-- ../media/l9_ldo_nmos_tikz.pdf -->

![](media/l9_ldo_nmos_tikz.pdf)


<small><sub>_Figure 6: Linear regulator with an NMOS pass-fet controlled by an OTA feedback loop_</sub></small>
...
<!-- ../media/l7_loadreg_tikz.pdf -->

![](media/l7_loadreg_tikz.pdf)


<small><sub>_Figure 7: Simulated pass-fet drain current against gate-source voltage for the 500 mA LDO testbench, five decades of current over one volt of gate drive_</sub></small>
...
<!-- ../media/l6_ldo_types_tikz.pdf -->

![](media/l6_ldo_types_tikz.pdf)


<small><sub>_Figure 8: Pass-fet control options: analog Vgs modulation, digital control of parallel instances, and duty-cycle control_</sub></small>
...
<!-- ../media/l7_ind_buck_tikz.pdf -->

![](media/l7_ind_buck_tikz.pdf)


<small><sub>_Figure 9: Principle of an inductive buck DC/DC converter: a switch, freewheeling diode, inductor and load capacitor_</sub></small>
...
<!-- ../media/l7_cap_buck_tikz.pdf -->

![](media/l7_cap_buck_tikz.pdf)


<small><sub>_Figure 10: Principle of a capacitive buck: two capacitors charged in series are reconfigured in parallel to halve the voltage_</sub></small>
...
<!-- ../media/l7_ind_boost_tikz.pdf -->

![](media/l7_ind_boost_tikz.pdf)


<small><sub>_Figure 11: Principle of an inductive boost DC/DC converter: the inductor current is pushed through the diode to an output above Vin_</sub></small>
...
<!-- ../media/l7_cap_boost_tikz.pdf -->

![](media/l7_cap_boost_tikz.pdf)


<small><sub>_Figure 12: Principle of a capacitive boost (charge pump): two capacitors charged in parallel are stacked in series to double the voltage_</sub></small>
...
<!-- ../media/l7_buck_tikz.pdf -->

![](media/l7_buck_tikz.pdf)


<small><sub>_Figure 13: Inductive switch-mode buck converter with control block, and waveforms of the inductor voltage Vx and current Ix_</sub></small>
...
<!-- ../media/l07_buck_pwm_fig_start_tikz.pdf -->

![](media/l07_buck_pwm_fig_start_tikz.pdf)


<small><sub>_Figure 14: Start-up of the PWM buck model: the inductor current Ix increases fast during A=1, while the output voltage vo grows like a second order function_</sub></small>
...
<!-- ../media/l07_buck_pwm_fig__tikz.pdf -->

![](media/l07_buck_pwm_fig__tikz.pdf)


<small><sub>_Figure 15: PWM buck model over a longer time: inductor and load currents (top), output voltage settling towards steady state (middle), and switch control A (bottom)_</sub></small>
...
<!-- ../media/l07_buck_pwm_fig_settled_tikz.pdf -->

![](media/l07_buck_pwm_fig_settled_tikz.pdf)


<small><sub>_Figure 16: PWM buck model in steady state. The inductor current swings 76 mA peak to peak to supply a 1 mA load, and the output capacitor turns that into 1.6 mV of ripple on a 998 mV output_</sub></small>
...
<!-- ../media/l9_sw_nRF53.png -->

![](media/l9_sw_nRF53.png)


<small><sub>_Figure 17: nRF5340 application schematic with three inductor/capacitor pairs, revealing three internal DC/DC converters. Source: Nordic Semiconductor, nRF5340 Product Specification_</sub></small>
...
<!-- ../media/l9_sw_arch_tikz.pdf -->

![](media/l9_sw_arch_tikz.pdf)


<small><sub>_Figure 18: PFM buck architecture with an FSM driving the switches, a zero-cross comparator, and an output voltage comparator_</sub></small>
...
<!-- ../media/l9_sw_state.pdf -->

![](media/l9_sw_state.pdf)


<small><sub>_Figure 19: Finite state machine for PFM control with IDLE, UP, and DWN states_</sub></small>
...
<!-- ../media/l07_buck_pfm_fig_save_tikz.pdf -->

![](media/l07_buck_pfm_fig_save_tikz.pdf)


<small><sub>_Figure 20: One period of the PFM buck model: inductor and load currents (top), output voltage (middle), and FSM state (bottom)_</sub></small>
