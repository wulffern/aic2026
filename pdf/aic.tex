...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
...

  {
    ...
    \input{version.tex}
		...
		{\small\noindent Written with substantial help from Claude, Anthropic's AI:\\
		many figures and passages are Claude's, on the author's direction\\
		and under his review. The repository's commit history records\\
		precisely who wrote what.}\\[\baselineskip]
	}
