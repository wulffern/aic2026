...
{
\centering
\aicfig{media/e5609e73606bb9b5c19542057b268cb5fea475348e101678c6fca9d24f94efd4.png}
}
...
{
\centering
\aicfig{media/0f84950939cb59a0ff515219d3a3501914dcdffafaf9b263899f9ff3c6bba1a4.png}
}
...
{
\centering
\aicfig{media/jnw_id_vgs_tikz.png}
}
...
{
\centering
\aicfig{media/jnw_gmid_vgs_tikz.png}
}
...
{
\centering
\aicfig{media/jnw_vdsat_gmid_tikz.png}
}
...
{
\centering
\aicfig{media/jnw_vg_gmid_tikz.png}
}
...
{
\centering
\aicfig{media/jnw_gmgds_gmid_tikz.png}
}
...
{
\centering
\aicfig{media/jnw_vg_gmid_corners_tikz.png}
}
...
{
\centering
\aicfig{media/jnw_vdsat_gmid_corners_tikz.png}
}
...
{
\centering
\aicfig{media/LELOTEMP_OTA_OP.png}
}
...
{
\centering
\aicfig{media/fig_current_mirrors.png}
}
...
{
\centering
\aicfig{media/fig_cmCascode.png}
}
...
{
\centering
\aicfig{media/cm_gain_boost_tikz.png}
}
...
{
\centering
\aicfig{media/amp_sf_ss_tikz.png}
}
...
cathode has to be the node and the junction is \emph{reverse} biased.
Turn the diode around and it is forward biased at 3 V, clamping the node
near 0.6 V, and there is no pixel left. The photocurrent therefore runs
against the triangle, down and out of the sense node, and that is where
the minus sign in \(\Delta V\) comes from: light does not charge the
node, it discharges it.
...
{
\centering
\aicfig{media/amp_why_sf_tikz.png}
}
...
{
\centering
\aicfig{media/amp_why_sf_not_tikz.png}
}
...
{
\centering
\aicfig{media/amp_cg_ss_rin_tikz.png}
}
...
{
\centering
\aicfig{media/amp_cg_ss_rout_tikz.png}
}
...
{
\centering
\aicfig{media/amp_cg_ss_a_tikz.png}
}
...
{
\centering
\aicfig{media/amp_cs_ss_tikz.png}
}
...
{
\centering
\aicfig{media/amp_why_cs_tikz.png}
}
...
{
\centering
\aicfig{media/amp_diff_tikz.png}
}
