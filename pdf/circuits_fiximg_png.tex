...
\tightlist
\item
  Nanoscale MOSFET Modeling: Part 1 {[}1{]}
\item
  Nanoscale MOSFET Modeling: Part 2 {[}2{]}.
\end{itemize}
...
to the versatility of MOSFETs {[}3{]}
...
10b Pipeline IF ADC Implemented in 1.2V/3.3V 0.13um CMOS {[}4{]}
...
{[}1{]}, and the modelling that backs it {[}2{]}

Settling and slewing in feedback amplifiers, which is where this
chapter's transient budget comes from {[}4{]}
