...
<small><sub>_Figure 1: Si base units, from [https://www.nist.gov/pml/owm/metric-si/si-units](https://www.nist.gov/pml/owm/metric-si/si-units). Image: NIST, US Department of Commerce (US federal work)_</sub></small>
...
<small><sub>_Figure 2: Standard model of particle physics, Wikipedia. Image: Cush after MissMJ, public domain, via Wikimedia Commons_</sub></small>
...
<!-- ../media/Solid_state_electronic_band_structure.png -->

![](media/Solid_state_electronic_band_structure.png)



<small><sub>_Figure 3: [Electronic band structure, Wikipedia](https://en.wikipedia.org/wiki/Electronic_band_structure). Image: Chetvorno, CC0, via Wikimedia Commons_</sub></small>
...
<!-- ../media/503px-Silicon-unit-cell-3D-balls.png -->

![](media/503px-Silicon-unit-cell-3D-balls.png)


<small><sub>_Figure 4: [Silicon, Wikipedia](https://en.wikipedia.org/wiki/Silicon). Image: Ben Mills, public domain, via Wikimedia Commons_</sub></small>
...
<!-- ../media/Band_filling_diagram.png -->

![](media/Band_filling_diagram.png)



<small><sub>_Figure 5: Band splitting in materials. [Electronic Band Structure, Wikipedia](https://en.wikipedia.org/wiki/Electronic_band_structure). Image: Nanite, CC0, via Wikimedia Commons_</sub></small>
...
<!-- ../media/Pn-junction_zero_bias.png -->

![](media/Pn-junction_zero_bias.png)


<small><sub>_Figure 6: [Band diagram of a PN junction, Wikipedia](https://en.wikipedia.org/wiki/Band_diagram). Image: Brews ohare, CC BY-SA 3.0, via Wikimedia Commons_</sub></small>
...
Think of flux as the "current", and the field as the "current density". 
You have to multiply the current density by an area to get current. You have to multiply the magnetic field by an area to get magnetic flux
