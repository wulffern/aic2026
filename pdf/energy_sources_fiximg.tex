...
fJ/conv.step \citeproc{ref-hsieh18}{{[}1{]}}.
...
Energy Harvesting \citeproc{ref-shirvanimoghaddam19}{{[}2{]}} {[}1{]}
has a nice overview of power consumption of technologies, seen in the
next figures below.
...
Access} 7 (2019) \citeproc{ref-shirvanimoghaddam19}{{[}2{]}}, licensed
CC BY 4.0}
...
Shirvanimoghaddam et al., \emph{IEEE Access} 7 (2019)
\citeproc{ref-shirvanimoghaddam19}{{[}2{]}}, licensed CC BY 4.0}
...
{
\centering
\aicfig{media/Absolute_Seebeck_coefficients_of_various_metals_up_to_high_temperatures.pdf}
}
...
\citeproc{ref-bose21}{{[}3{]}} they use a combination of both switched
capacitor and switched inductor boost.


{
\centering
\aicfig{media/l11_teg_mdl_tikz.pdf}
}
...
{
\centering
\aicfig{media/l11_pv_pn_tikz.pdf}
}
...
{
\centering
\aicfig{media/l11_pv_mdl_tikz.pdf}
}
...
Devices \citeproc{ref-cheng21}{{[}4{]}} they include a maximum power
point tracker and a reconfigurable charge pump to optimize efficiency.
...
Harvesting \citeproc{ref-du19}{{[}5{]}}


{
\centering
\aicfig{media/lx_piezo_mdl_tikz.pdf}
}
...
for triboelectric nanogenerators \citeproc{ref-hu22}{{[}6{]}}.
...
\citeproc{ref-tan21}{{[}7{]}} for more details.


{
\centering
\aicfig{media/lx_trib_mdl_tikz.pdf}
}

\emph{Figure 16: Model of a triboelectric generator - an AC source in
series with the transducer capacitance}

Tan et al. \citeproc{ref-tan21}{{[}7{]}} built exactly this, and it is
worth walking through because it is a complete system rather than a
circuit.
...
Numbers from Tan et al. \citeproc{ref-tan21}{{[}7{]}}.
