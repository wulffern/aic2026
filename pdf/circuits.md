...
![](media/e5609e73606bb9b5c19542057b268cb5fea475348e101678c6fca9d24f94efd4.svg)



<small><sub>_Figure 1: JNWATR_PCH_2C1F2 transistor _</sub></small> 

<!-- https://analogicus.github.io/jnw_atr_sky130A/assets/JNWATR_PCH_2C5F0.svg -->

![](media/0f84950939cb59a0ff515219d3a3501914dcdffafaf9b263899f9ff3c6bba1a4.svg)


<small><sub>_Figure 2: JNWATR_PCH_2C5F0 transistor _</sub></small> 
...
<!-- ../media/jnw_id_vgs_tikz.pdf -->

![](media/jnw_id_vgs_tikz.pdf)


<small><sub>_Figure 3: Log of drain current versus gate/source voltage _</sub></small> 
...
<!-- ../media/jnw_gmid_vgs_tikz.pdf -->

![](media/jnw_gmid_vgs_tikz.pdf)


<small><sub>_Figure 4: gm/Id (Y-axis) versus Gate voltage (X-axis) _</sub></small> 
...
<!-- ../media/jnw_vdsat_gmid_tikz.pdf -->

![](media/jnw_vdsat_gmid_tikz.pdf)


<small><sub>_Figure 5: Vdsat versus gm/Id _</sub></small> 
...
<!-- ../media/jnw_vg_gmid_tikz.pdf -->

![](media/jnw_vg_gmid_tikz.pdf)


<small><sub>_Figure 6: Vg versus gm/Id _</sub></small> 
...
<!-- ../media/jnw_gmgds_gmid_tikz.pdf -->

![](media/jnw_gmgds_gmid_tikz.pdf)


<small><sub>_Figure 7: gm/gds versus gm/Id _</sub></small> 
...
<!-- ../media/jnw_vg_gmid_corners_tikz.pdf -->

![](media/jnw_vg_gmid_corners_tikz.pdf)


<small><sub>_Figure 8: Gate-source voltage as a function of corner _</sub></small> 
...
<!-- ../media/jnw_vdsat_gmid_corners_tikz.pdf -->

![](media/jnw_vdsat_gmid_corners_tikz.pdf)


<small><sub>_Figure 9: Drain Saturation Voltage as a function of corner _</sub></small> 
...
<!-- ../media/LELOTEMP_OTA_OP.svg -->

![](media/LELOTEMP_OTA_OP.svg)


<small><sub>_Figure 10: Example of operating point annotation _</sub></small>
...
<!-- ../media/l8/fig_current_mirrors.pdf -->

![](media/fig_current_mirrors.pdf)


<small><sub>_Figure 11: Example of current mirrors _</sub></small>
...
<small><sub>_Figure 12: Normal current mirror _</sub></small>
...
<!-- ../media/l8/fig_cmsf.pdf -->

![](media/fig_cmsf.pdf)



<small><sub>_Figure 13: Source degenerated current mirror _</sub></small>
...
<!-- ../media/cm_sdeg_tikz.pdf -->

![](media/cm_sdeg_tikz.pdf)


<small><sub>_Figure 14: Source degenerated current mirror small signal model _</sub></small>
...
<!-- ../media/l8/fig_cmCascode.pdf -->

![](media/fig_cmCascode.pdf)


<small><sub>_Figure 15: Cascoded current mirror _</sub></small>
...
and it must go to the amplifier's *inverting* input, with $V_B$ on the
non-inverting one. Then a rise on that node drives the cascode gate
down, the cascode conducts less, and the node comes back down. Swap the
two inputs and every part of that sentence reverses: the node rises, the
gate rises, the cascode pulls harder, and the node rises further. Same
devices, same $A$, and the loop runs to a rail instead of regulating.
...
<!-- ../media/cm_gain_boost_tikz.pdf -->

![](media/cm_gain_boost_tikz.pdf)


<small><sub>_Figure 16: Active cascode current mirror _</sub></small>
...
<!-- ../media/amp_sf_tikz.pdf -->

![](media/amp_sf_tikz.pdf)


<small><sub>_Figure 17: Source follower _</sub></small>
...
<!-- ../media/amp_sf_ss_tikz.pdf -->

![](media/amp_sf_ss_tikz.pdf)


<small><sub>_Figure 18: Source follower small signal model_</sub></small>
...
<!-- ../media/amp_why_sf_tikz.pdf -->

![](media/amp_why_sf_tikz.pdf)


<small><sub>_Figure 19: Sense node buffered by a source follower_</sub></small>
...
<!-- ../media/amp_why_sf_not_tikz.pdf -->

![](media/amp_why_sf_not_tikz.pdf)


<small><sub>_Figure 20: The same sense node connected straight to the bus_</sub></small>
...
<!-- ../media/amp_cg_tikz.pdf -->

![](media/amp_cg_tikz.pdf)


<small><sub>_Figure 21: Common gate stage_</sub></small>
...
<!-- ../media/amp_cg_ss_rin_tikz.pdf -->

![](media/amp_cg_ss_rin_tikz.pdf)


<small><sub>_Figure 22: Common gate input resistance_</sub></small>
...
<!-- ../media/amp_cg_ss_rout_tikz.pdf -->

![](media/amp_cg_ss_rout_tikz.pdf)


<small><sub>_Figure 23: Common gate output resistance_</sub></small>
...
<!-- ../media/amp_cg_ss_a_tikz.pdf -->

![](media/amp_cg_ss_a_tikz.pdf)


<small><sub>_Figure 24: Common gate small signal gain_</sub></small>
...
<!-- ../media/amp_cs_tikz.pdf -->

![](media/amp_cs_tikz.pdf)


<small><sub>_Figure 25: Common source stage_</sub></small>
...
<!-- ../media/amp_cs_ss_tikz.pdf -->

![](media/amp_cs_ss_tikz.pdf)


<small><sub>_Figure 26: Common source small signal model_</sub></small>
...
<!-- ../media/amp_why_cs_tikz.pdf -->

![](media/amp_why_cs_tikz.pdf)


<small><sub>_Figure 27: A low noise amplifier is a common source stage_</sub></small>
...
<!-- ../media/amp_diff_tikz.pdf -->

![](media/amp_diff_tikz.pdf)


<small><sub>_Figure 28: Differential pair_</sub></small>
