...
1999, R. Walden: Analog-to-digital converter survey and analysis {[}1{]}
...
for Bluetooth Low Energy Receivers {[}2{]}
...
{
\centering
\aicfig{media/l06_fig_layout.pdf}
}
...
{
\centering
\aicfig{media/l06_core_meas_tikz.pdf}
}
...
{
\centering
\aicfig{media/l06_jssc_table.pdf}
}
...
{
\centering
\aicfig{media/l06_fig_saremx.pdf}
}
...
{
\centering
\aicfig{media/l06_fig_process.pdf}
}
...
{
\centering
\aicfig{media/harald_layout.pdf}
}
...
{
\centering
\aicfig{media/quant_noise_tikz.pdf}
}
...
{
\centering
\aicfig{media/l6_q_1_fharm_tikz.pdf}
}
...
{
\centering
\aicfig{media/l6_osr_2_tikz.pdf}
}
...
{
\centering
\aicfig{media/l6_osr_4_tikz.pdf}
}
...
{
\centering
\aicfig{media/l4_sdloop_tikz.pdf}
}
...
{
\centering
\aicfig{media/l6_sdadc_tikz.pdf}
}
...
{
\centering
\aicfig{media/l6_sd_d0_b1_tikz.pdf}
}
...
{
\centering
\aicfig{media/l6_sd_d1_b1_tikz.pdf}
}
...
{
\centering
\aicfig{media/l6_sdlog_d1_b5_tikz.pdf}
}
...
Resonators in Open-Loop Sigma-Delta Modulators {[}4{]}
...
{
\centering
\aicfig{media/l6_fredrik_arch.pdf}
}
...
{
\centering
\aicfig{media/l6_fredrik_psd.pdf}
}
...
Delta-sigma modulation in fractional-N frequency synthesis {[}8{]}

A CMOS Temperature Sensor With a Voltage-Calibrated Inaccuracy of ± 0.15
C (3sigma) From -55 Cto 125 C {[}9{]}

A 20-mW 640-MHz CMOS Continuous-Time Sigma-Delta ADC With 20-MHz Signal
Bandwidth, 80-dB Dynamic Range and 12-bit ENOB {[}10{]}

A Micro-Power Two-Step Incremental Analog-to-Digital Converter {[}11{]}
