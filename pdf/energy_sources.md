...
<!-- ../media/shirv5-2928523-large.gif -->

![](media/shirv5-2928523-large.gif)


<small><sub>_Figure 1: The couplings between the electrical, mechanical and thermal energy domains, including the piezoelectric, pyroelectric and thermoelectric effects. From Shirvanimoghaddam et al., *IEEE Access* 7 (2019) [@shirvanimoghaddam19], licensed CC BY 4.0_</sub></small>
...
<!-- ../media/shirv6-2928523-large.gif -->

![](media/shirv6-2928523-large.gif)


<small><sub>_Figure 2: Battery run-time and power consumption of devices from a 32 kHz quartz oscillator to a laptop, plotted against the energy available from mechanical, thermal and radiant sources in uW/cm2. From Shirvanimoghaddam et al., *IEEE Access* 7 (2019) [@shirvanimoghaddam19], licensed CC BY 4.0_</sub></small>
...
<!-- ../media/shirv11-2928523-large.gif -->

![](media/shirv11-2928523-large.gif)


<small><sub>_Figure 3: Power versus coverage for wireless standards, showing that NFC, RFID, Z-Wave and Zigbee can be battery-less while WiFi, Bluetooth and the cellular standards need a battery. From Shirvanimoghaddam et al., *IEEE Access* 7 (2019) [@shirvanimoghaddam19], licensed CC BY 4.0_</sub></small>
...
<!-- ../media/Thermoelectric_effect.png -->

![](media/Thermoelectric_effect.png)


<small><sub>_Figure 4: The thermoelectric effect - iron and copper wires joined at a heated end drive a current through a meter connected at the cold end. Image: Cmglee, CC BY-SA 4.0, via Wikimedia Commons_</sub></small>
...
<!-- ../media/Absolute_Seebeck_coefficients_of_various_metals_up_to_high_temperatures.svg -->

![](media/Absolute_Seebeck_coefficients_of_various_metals_up_to_high_temperatures.svg)


<small><sub>_Figure 5: Absolute Seebeck coefficient versus temperature for a range of metals, spanning roughly +20 uV/K for tungsten to -60 uV/K for palladium. Image: Nanite, CC0, via Wikimedia Commons_</sub></small>
...
<!-- ../media/Mott_Seebeck_silicon.png -->

![](media/Mott_Seebeck_silicon.png)


<small><sub>_Figure 6: Seebeck coefficient and conductivity of silicon as a function of Fermi level, with the sign flipping between the valence and conduction band edges. Image: Nanite, CC0, via Wikimedia Commons_</sub></small>
...
<!-- ../media/Thermoelectric_Generator_Diagram.png -->

![](media/Thermoelectric_Generator_Diagram.png)


<small><sub>_Figure 7: Thermoelectric generator, where n-type and p-type legs between a heat source and a cool side drive a current through the load resistor. Image: Ken Brazier, CC BY-SA 4.0, via Wikimedia Commons_</sub></small>
...
<!-- ../media/Thermoelectric_Cooler_Diagram.png -->

![](media/Thermoelectric_Cooler_Diagram.png)


<small><sub>_Figure 8: The same structure run in reverse as a Peltier cooler, where a forced current cools the top surface and dissipates heat at the bottom. Image: Ken Brazier, CC BY-SA 4.0, via Wikimedia Commons_</sub></small>
...
<!-- ../media/1280px-Voyager_spacecraft_model.png -->

![](media/1280px-Voyager_spacecraft_model.png)


<small><sub>_Figure 9: The Voyager spacecraft, whose radioisotope thermoelectric generator is the finned cylinder below the dish. Image: NASA, public domain, via Wikimedia Commons_</sub></small>
...
<!-- ../media/l11_teg_mdl_tikz.pdf -->

![](media/l11_teg_mdl_tikz.pdf)


<small><sub>_Figure 10: Model of a thermoelectric generator - a 1 to 50 mV/K source in series with a source resistance below 10 ohm - together with the self-starting boost converter architecture from Bose et al._</sub></small>
...
<!-- ../media/l11_pv_pn_tikz.pdf -->

![](media/l11_pv_pn_tikz.pdf)


<small><sub>_Figure 11: Photon absorption in a PN junction, where electron/hole pairs generated in the depletion region (1), the P region (2) and the N region (3) all increase the diode voltage VD_</sub></small>
...
<!-- ../media/l11_pv_mdl_tikz.pdf -->

![](media/l11_pv_mdl_tikz.pdf)


<small><sub>_Figure 12: Circuit model of a photodiode - a photo current source in parallel with a diode, delivering a load current IL_</sub></small>
...
<small><sub>_Figure 13: Diode voltage and delivered power versus load current for the photodiode model, with the maximum power point near 0.9 mA_</sub></small>
...
<!-- ../media/lx_piezo_mdl_tikz.pdf -->

![](media/lx_piezo_mdl_tikz.pdf)


<small><sub>_Figure 14: Model of a piezoelectric transducer - an AC current source in parallel with the transducer capacitance_</sub></small>
...
<!-- ../media/FarNearFields-USP-4998112-1.png -->

![](media/FarNearFields-USP-4998112-1.png)


<small><sub>_Figure 15: The reactive near field, radiative (Fresnel) near field and far field regions around an antenna. Image: Goran M Djuknic, public domain (US patent), via Wikimedia Commons_</sub></small>
...
<small><sub>_Stupidity in engineering really annoys me, especially when people don't understand how stupid ideas are._</sub></small>
...
<!-- ../media/lx_trib_mdl_tikz.pdf -->

![](media/lx_trib_mdl_tikz.pdf)


<small><sub>_Figure 16: Model of a triboelectric generator - an AC source in series with the transducer capacitance_</sub></small>
