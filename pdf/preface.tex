...
% The figure colours, defined here as well because the figures compile
% standalone with their own preamble and the book preamble does not
% otherwise need them. definecolor overwrites silently, so a later
% definition elsewhere is harmless.
...
line style carry meaning everywhere. The palette is chosen as a
luminance ladder: printed in black and white, every colour lands on
a distinct gray.
...
\item {\color{oxteal}\textbf{Teal}} is the gate oxide,
  wherever it appears.
