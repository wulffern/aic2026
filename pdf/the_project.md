...
<!-- ../media/nrf54L15_power.pdf -->

![](media/nrf54L15_power.pdf)


<small><sub>_Figure 2: Power system of nRF54L15 _</sub></small>
...
<small><sub>_Figure 3: Leakage simulation _</sub></small>
...
<!-- ../media/aic2026_project_analog.svg -->

![](media/aic2026_project_analog.svg)


<small><sub>_Figure 4: Illustration of the temperature sensor _</sub></small>
...
<!-- ../media/aic2026_project.svg -->

![](media/aic2026_project.svg)


<small><sub>_Figure 5: Project overview _</sub></small>
...
<small><sub>_Figure 6: PTAT current generator, where an op amp forces equal voltages across the two bipolar branches so that $\Delta V_{BE}$ over $R_1$ sets $I_{PTAT}$_</sub></small>
...
<small><sub>_Figure 7: Relaxation oscillator, where a current charges capacitor $C$ until the comparator trips against the reference voltage $V_1$ across $R$, and the flip-flop resets the capacitor_</sub></small>
...
![](media/b6546506e714da05dd00b32acfe99950fcff6a2aea264115ce7296c2a71638f3.svg)


<small><sub>_Figure 8: State machine that measures the oscillator frequency, cycling IDLE, PWRUP (count oscillator pulses), PWRDWN and CAPTURE (store counter value)_</sub></small>
...
<!-- ../media/l00_layout.pdf -->

![](media/l00_layout.pdf)


<small><sub>_Figure 9: Physical layout of a circuit in the Magic layout editor, with the DRC error count shown as zero in the toolbar_</sub></small>
