...
<small><sub>_Figure 2: Magic with the transistor instances stacked on top of each other, shown as boxes on the left and with layers drawn on the right_</sub></small>
...
<small><sub>_Figure 3: The source terminals of all transistors connected down to the ground rail, DRC clean_</sub></small>
...
<small><sub>_Figure 4: The gates routed together, with the gate to drain connection of M1 made in locali_</sub></small>
...
<small><sub>_Figure 5: The drain connections routed with the wire tool, using vias to change metal layer_</sub></small>
...
<small><sub>_Figure 6: The completed LELO_EX layout with labelled ports, ready for the LVS check against the schematic_</sub></small>
