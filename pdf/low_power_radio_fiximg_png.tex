...
{
\centering
\aicfig{media/International_Telecommunication_Union_regions_with_dividing_lines.png}
}
...
{
\centering
\aicfig{media/l7_bpsk_real_tikz.png}
}
...
{
\centering
\aicfig{media/l7_bpsk_circuit_tikz.png}
}
...
{
\centering
\aicfig{media/l7_const_env_tikz.png}
}
...
{
\centering
\aicfig{media/l7_polar_tikz.png}
}
...
{
\centering
\aicfig{media/l8_cartesian_tikz.png}
}
...
{
\centering
\aicfig{media/l8_16qam_tikz.png}
}
...
{
\centering
\aicfig{media/l10_single_carrier_tikz.png}
}
...
{
\centering
\aicfig{media/l10_multiple_carrier_tikz.png}
}
...
{
\centering
\aicfig{media/lg_lna_adc_tikz.png}
}
...
{
\centering
\aicfig{media/l10_lprxarch_tikz.png}
}
...
Complex signal processing is not complex {[}2{]}
...
Offset in 22nm FDSOI {[}3{]}


{
\centering
\aicfig{media/l10_mix_tikz.png}
}
...
Noise-Shaping SAR ADC With On-Chip CDAC Calibration {[}4{]} as shown in
the figure below.
...
{
\centering
\aicfig{media/l08_pll_2mod_tikz.png}
}
...
{
\centering
\aicfig{media/pll_master_arch_28feb2020.png}
}
...
{[}1{]}, M. Tamura, Sony Semiconductor Solutions, Atsugi, Japan, 30.5,
ISSCC 2020

A 370uW 5.5dB-NF BLE/BT5.0/IEEE 802.15.4-Compliant Receiver with
\textgreater63dB Adjacent Channel Rejection at \textgreater2 Channels
Offset in 22nm FDSOI {[}3{]}, B. J. Thijssen, University of Twente,
Enschede, The Netherlands

A 68 dB SNDR Compiled Noise-Shaping SAR ADC With On-Chip CDAC
Calibration {[}4{]}, H. Garvik, C. Wulff, T. Ytterdal

A Compiled 9-bit 20-MS/s 3.5-fJ/conv.step SAR ADC in 28-nm FDSOI for
Bluetooth Low Energy Receivers {[}5{]}, C. Wulff, T. Ytterdal
...
Design of CMOS Phase-Locked Loops {[}6{]}, Behzad Razavi, University of
