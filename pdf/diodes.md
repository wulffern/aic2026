...
<small><sub>_Figure 1: Silicon crystal unit cell. Image: Ben Mills, public domain, via Wikimedia Commons_</sub></small>
...
<small><sub>_Figure 2: Intrinsic carrier concentration versus temperature_</sub></small>
...
<small><sub>_Figure 3: Diode forward voltage as a function of temperature_</sub></small>
...
<small><sub>_Figure 4: Circuit to generate a current proportional to kT_</sub></small>
...
<!-- ../media/antenna_diode_leak_tikz.pdf -->

![](media/antenna_diode_leak_tikz.pdf)


<small><sub>_Figure 5: Reverse leakage density (A/um$^2$) of an n+/p-well
...
the steps at which plasma-induced gate damage occurs._</sub></small>
