...
{
\centering
\aicfig{media/timeline_tikz.pdf}
}
...
{
\centering
\aicfig{media/l01_universe_tikz.pdf}
}
...
Johns and Martin \citeproc{ref-cjm11}{{[}1{]}}, which everyone calls
CJM, and Circuits for all seasons.
