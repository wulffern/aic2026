...
\begin{tikzpicture}[scale=0.85]
  ...
  % barrier height
  \draw[eblue, thick, latex-latex] (2.85,1.25) -- (3.15,2.55);
  \node[eblue, anchor=east, scale=0.9] at (3.35,2.2) {$\phi_B$};
  ...
  \draw[eblue, thick, -latex] (3.3,-1.15) -- (2.5,-1.15);
  ...
  \draw[eblue, thick, -latex] (7.0,-1.15) -- (6.65,-1.15);
