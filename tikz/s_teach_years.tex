...
\begin{tikzpicture}[line width=0.5pt]
  ...
  % ---- axis -------------------------------------------------------------
  \draw[line width=0.9pt,-latex] (-1.0,0) -- (21.4,0);
  ...
  \foreach \i/\h/\t in {%
    ...
    4/1.1/{GitHub CI:\\DRC / LVS / GDS\\on every push},
    5/2.4/{Docs workflow.\\Tiny Tapeout named\\as the goal},
    6/1.1/{Tapeout pre-check\\in CI. Shuttle paid for}%
  }{
  ...
  % 2024: one group, no tapeout
  \node[todo] at (4*\dx,-1.55) {};
  \node[note,anchor=north] at (4*\dx,-2.3) {0 of 1};
  ...
  \node[note,anchor=north] at (5*\dx,-2.9) {\textsc{ttsky25a}};
  ...
  \node[note,anchor=north] at (6*\dx,-2.95) {\textsc{ttsky26c}};
