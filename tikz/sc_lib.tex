...
\newcommand{\scIntroFrame}{%
  ...
  % C2 across the OTA
  \draw[axisblue, thick] (\scXctwo,\scYin) -- (\scXctwo,\scYctwo);
  \fill[axisblue] (\scXctwo,\scYin) circle (0.07);
  \draw[axisblue, thick] (\scXctwo,\scYctwo) \hcapacitor{};
  \draw[axisblue, thick] (5.6,\scYctwo) -- (\scXout,\scYctwo) -- (\scXout,\scYin-0.4);
  \draw[axisblue, thick] (\scXout,\scYin-0.4) -- (cicOtaS_out);
  \node[capgreen, anchor=south] at (5.8,\scYctwo+0.15) {$C_{2}$};
  \node[polred, anchor=east]    at (3.9,\scYctwo-0.45) {$-$};
  \node[polred, anchor=west]    at (5.7,\scYctwo-0.45) {$+$};

  % The path that shorts C2, minus its switch
  \draw[axisblue, thick] (\scXctwo,\scYctwo) -- (\scXctwo,\scYsh) -- (4.8,\scYsh);
  \draw[axisblue, thick] (5.8,\scYsh) -- (\scXshr,\scYsh) -- (\scXshr,\scYctwo);
  \fill[axisblue] (\scXshr,\scYctwo) circle (0.07);
}
