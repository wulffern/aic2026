...
\newcommand{\scWavTop}{4.3}      % top of the V_o axis
...
\newcommand{\scWaveFrame}{%
  \draw[thick,->] (-0.3,0) -- (5.8,0);
  \node[anchor=north west] at (5.5,-0.28) {$t$};
  \draw[thick,->] (0,-0.2) -- (0,\scWavTop);
  \node[anchor=east] at (-0.12,\scWavTop-0.12) {$V_{o}$};
  ...
  \node[anchor=south] at (2.4,{\scWavTop+0.05}) {$C_{1} = C_{2}$};
