...
\begin{circuitikz}[american, thick, transform shape]
  ...
  \draw (\xcm,\ytop) -- (\xcm,\ytop+0.55)
        to [switch] (\xcm,\ytop+1.5);
  \node[scale=0.8, anchor=west] at (\xcm+0.15,\ytop+1.02) {$\phi_2$};
  \draw (\xcm,\ytop+1.5) node[rotate=180]{} ;
  \draw (\xcm-0.3,\ytop+1.5) -- (\xcm+0.3,\ytop+1.5);
  \draw (\xcm-0.19,\ytop+1.62) -- (\xcm+0.19,\ytop+1.62);
  \draw (\xcm-0.08,\ytop+1.74) -- (\xcm+0.08,\ytop+1.74);

  \draw (\xcm,\ybot) -- (\xcm,\ybot-0.55)
        to [switch] (\xcm,\ybot-1.5);
  \node[scale=0.8, anchor=west] at (\xcm+0.15,\ybot-1.02) {$\phi_2$};
  \draw (\xcm-0.3,\ybot-1.5) -- (\xcm+0.3,\ybot-1.5);
  \draw (\xcm-0.19,\ybot-1.62) -- (\xcm+0.19,\ybot-1.62);
  \draw (\xcm-0.08,\ybot-1.74) -- (\xcm+0.08,\ybot-1.74);
