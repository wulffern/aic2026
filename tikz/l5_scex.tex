...
\begin{circuitikz}[american, transform shape]
  ...
  \draw[thick] (\exXr,0.4) node[ground] {};
  ...
  \node[anchor=east] at (7.1,2.8) {$C_{1} = 1\,\mathrm{pF}$};
  ...
  \node[anchor=south] at (10.8,6.05) {$C_{2} = 100\,\mathrm{fF}$};
  ...
  \node[anchor=north] at (10.8,-0.45) {$C_{2} = 100\,\mathrm{fF}$};
