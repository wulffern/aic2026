...
\begin{circuitikz}[american, thick, transform shape, circuit ee IEC]
  ...
  \newcommand{\mixsw}[3]{%
    ...
    \draw (#3.G) -- (0.85,{#1+1.15});
    \draw (0.55,{#1+1.15}) -- (1.15,{#1+1.15});
    \draw (0.55,{#1+1.35}) -- (1.15,{#1+1.35});
    \draw (0.85,{#1+1.35}) -- (0.85,{#1+1.9});
    \draw (0.85,{#1+1.9}) to [short,-o] (0.85,{#1+2.02});
    ...
    \node[anchor=west] at (1.06,{#1+2.02}) {#2};
    ...
    % reaches.
    \fill (0.85,{#1+0.92}) circle (0.075);
    \draw (0.85,{#1+0.92}) -- (1.5,{#1+0.92});
    \draw (1.5,{#1+0.92}) \hresistor{};
    \draw (3.1,{#1+0.92}) to [short,-o] (3.22,{#1+0.92});
    \node[anchor=west] at (3.38,{#1+0.92}) {$V_n$};
  }
