...
\begin{circuitikz}[american, thick, transform shape, circuit ee IEC]
  ...
  \node[anchor=north] at (\xb/2,-0.8) {$Q_{A}$ and $Q_{B}$ identical};
  ...
  \node[anchor=east, scale=0.9] at ({\xn-0.55},{\ytop+0.8}) {$M_{PC}$};
  \draw (\xd,\ytop) \lvpmos{MPD}{};
  \draw (\xd,\ysup) \vsupply;
  \node[anchor=west, scale=0.9] at ({\xd+0.55},{\ytop+0.8}) {$M_{PD}$};
