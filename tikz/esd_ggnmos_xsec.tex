...
\begin{circuitikz}[american, thick, transform shape]
  ...
  %- depletion regions, drawn first so the implants sit on top
  \draw (1.75,0) rectangle (4.53,\ddep);
  \draw (6.65,0) rectangle (9.50,\ddep);
  ...
  \draw (-0.2,0) -- (9.95,0);
  \node[anchor=center] at (5.30,-2.14) {P-};

  %- gate stack: oxide strip, then poly, overlapping both junctions
