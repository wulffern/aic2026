...
\begin{circuitikz}[american, transform shape]
  ...
  \node[bandorange, anchor=east] at (-1.55,\specYtop+1.95) {LP filter};
  \draw[bandorange, thick, ->] (-1.5,\specYtop+1.90) -- (-1.15,\specYtop+1.75);
  ...
  \node[annotblue, anchor=south] at (5.65,3.3) {Anti-alias};
  \draw[annotblue, thick, ->] (5.65,3.25) -- (5.65,2.55);
