...
\begin{circuitikz}[american, thick, transform shape]
  ...
  %- the bias current flows from the supply down into the drain, as
  %- everywhere else in the book
  \draw (3.4,{\yA+3.0}) to [I] (3.4,{\yA+1.6});
  ...
  \draw ($(gate)+(-1.2,-1.6)$) \vcapacitor{};
  \draw ($(gate)+(-1.2,-1.6)$) \vground;
  ...
  \draw (cgdT) \hcapacitor{$C_{gd}$} -- (cgdT -| 2,0);
  \draw (cgdT -| 2,0) -- (drain);
  ...
  % the Miller step
  \draw[->, thick] (2.0,{\yB-1.6}) -- (2.0,{\yB-2.2});
