...
\begin{circuitikz}[american, transform shape]
  ...
  % ---- NMOS pass device ----
  \def\xa{0}
  \draw[thick] (\xa+0.1,0) to [Tnmos, n=MN] (\xa+2.0,0);
  \draw[thick] (MN.gate) -- ++(0,0.55);
  ...
  \def\xb{4.0}
  \draw[thick] (\xb+0.1,0) to [Tpmos, n=MP] (\xb+2.0,0);
  \draw[thick] (MP.gate) -- ++(0,0.55);
  ...
  \def\xc{8.4}
  \draw[thick] (\xc+0.1,0) -- (\xc+0.6,0) -- (\xc+0.6,0.9);
  \draw[thick] (\xc+0.6,0.9) to [Tpmos, n=TP] (\xc+2.4,0.9);
  \draw[thick] (\xc+2.4,0.9) -- (\xc+2.4,0) -- (\xc+2.9,0);
  \draw[thick] (\xc+0.6,0) -- (\xc+0.6,-0.9);
  \draw[thick] (\xc+0.6,-0.9) to [Tnmos, n=TN, mirror] (\xc+2.4,-0.9);
  \draw[thick] (\xc+2.4,-0.9) -- (\xc+2.4,0);
  \fill (\xc+0.6,0) circle (0.07);
  \fill (\xc+2.4,0) circle (0.07);
  \draw[thick] (TP.gate) -- ++(0,0.5);
  \draw[thick] (TN.gate) -- ++(0,-0.5);
  ...
  \def\yd{-5.0}
  \draw[thick] (\xd,\yd+0.75) -- (\xd,\yd-0.75) -- (\xd+1.05,\yd) -- cycle;
  \draw[thick] (\xd+2.1,\yd+0.75) -- (\xd+2.1,\yd-0.75) -- (\xd+1.05,\yd) -- cycle;
  \draw[thick] (\xd-0.6,\yd) -- (\xd,\yd);
  \draw[thick] (\xd+2.1,\yd) -- (\xd+2.7,\yd);
  \draw[thick] (\xd+1.05,\yd+1.05) -- (\xd+1.05,\yd+0.40);
  \draw[thick] (\xd+1.05,\yd+0.28) circle (0.12);
  \draw[thick] (\xd+1.05,\yd) -- (\xd+1.05,\yd-1.05);
