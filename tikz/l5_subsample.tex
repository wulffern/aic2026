...
\begin{circuitikz}[american, transform shape]
  ...
  \specAxis{\specYtop}
  \specBand{-2.64}{0.50}{1.25}{\specYtop}
  \specBand{2.64}{0.50}{1.25}{\specYtop}
  \specBump{\specYtop}
  \specTone{toneA}{-2.64}{\specYtop}     % -1.1 fs, inside the passband
  \specTone{toneB}{-1.44}{\specYtop}     % -0.6 fs, rejected
  \specTone{toneB}{1.44}{\specYtop}
  \specTone{toneA}{2.64}{\specYtop}
  \node[specfilter, anchor=west] at (-2.05,\specYtop+1.55) {BP filter};
  \draw[specfilter, thick, ->] (-2.1,\specYtop+1.50) -- (-2.45,\specYtop+1.32);
