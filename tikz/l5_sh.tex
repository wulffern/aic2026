...
% relative order the original shows -- the second pair ending up outside the first -- is
...
\begin{circuitikz}[american, thick, transform shape]
  ...
  \specAxis{\specYbot}
  \specBump{\specYbot}
  \specTone{toneA}{-0.24}{\specYbot}     % 1.1 fs - fs = 0.1 fs
  \specTone{toneB}{-0.96}{\specYbot}     % 0.6 fs - fs = -0.4 fs
  \specTone{toneB}{0.96}{\specYbot}
  \specTone{toneA}{0.24}{\specYbot}
