...
\newcommand{\drainzoomframe}{%
  ...
  \node[anchor=west, scale=1.0] at (7.6,1.6) {DRAIN \; $n+$};
  % V_DS-sat and ~V_DS marks with the x span
  \draw[thick] (4.2,4.68) -- (4.2,4.9);
  \node[anchor=south east, scale=0.8] at (4.25,4.92) {$V_{DS\text{-}sat}$};
  \draw[thick] (6.6,4.68) -- (6.6,4.9);
  \node[anchor=south west, scale=0.8] at (6.55,4.92) {$\sim V_{DS}$};
  \draw[latex-latex, thin] (4.3,4.79) -- (6.5,4.79);
