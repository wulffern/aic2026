...
\newcommand{\drainzoomframe}{%
  ...
  \draw[thick] (4.2,4.7) -- (4.2,4.85);
  \node[anchor=south, scale=0.75] at (4.2,4.87) {$V_{DS\text{-}sat}$};
  \draw[thick] (6.6,4.7) -- (6.6,4.85);
  \node[anchor=south, scale=0.75] at (6.6,4.87) {$\sim V_{DS}$};
  \draw[latex-latex, thin] (4.35,4.78) -- (6.45,4.78);
  \node[anchor=south, scale=0.8] at (5.4,4.82) {$x$};
  % bias
