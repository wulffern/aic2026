...
% bias VCP; a VBP/VCP branch into a long-L NMOS diode makes VCN; a
% stack of two NMOS diodes fed from a second VBP/VCP branch makes VBN;
...
\begin{circuitikz}[american, thick, transform shape, circuit ee IEC]
  ...
  % lower NMOS diode: its gate/drain is VBN
  ...
  \draw (9.82,3.95) -- (15.4,3.95) to [short,-o] ++(0.5,0) node[anchor=west] {$VCN$};
