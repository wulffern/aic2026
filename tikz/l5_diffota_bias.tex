...
\begin{circuitikz}[american, thick, transform shape, circuit ee IEC]
  ...
  % the wide-swing master: a VCN-gated cascode on top, the diode
  % below it. Only the PMOS mirror sets the branch current; the
  % cascode holds the diode's drain at a mirror-matched V_DS, and
  % VBN is the diode's gate/drain.
  \draw (6.0,4.6) -- (6.0,4.0);
  \draw (6.0,2.4) to [Tnmos, n=mnd1, mirror] ++(0,\grid);
  \dsize{4.75}{2.8}{24F2F\\M=2}
  ...
  \draw (5.02,0.8) -- (5.02,2.3);
  \fill (5.02,2.3) circle (0.075);
  \fill (6.0,2.3) circle (0.075);
  \draw (5.02,2.3) -- (15.4,2.3) to [short,-o] ++(0.5,0) node[anchor=west] {$VBN$};
